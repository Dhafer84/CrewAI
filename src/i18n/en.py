...
CATALOGUE: dict[str, str] = {
    ...
    "about.doctrine": "The doctrine",
    "about.doctrine.title": "AI <em>never decides</em>",
    "about.fact.years": "18+ years",
    "about.fact.years.text": "in automotive and industrial electronics",
